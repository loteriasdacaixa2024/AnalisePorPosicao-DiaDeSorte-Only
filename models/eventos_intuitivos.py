...
# Models: Eventos Intuitivos CORRIGIDO

"""
ESTE ARQUIVO VAI EM: models/eventos_intuitivos.py

CORREÇÃO APLICADA:
- O problema era criar uma NOVA instância de SQLAlchemy() aqui
- Isso fazia com que EventoIntuitivo.query.get(id) usasse um db diferente
- SOLUÇÃO: Importar o db de sorteio.py (que já está inicializado com o Flask)
"""

from datetime import datetime
# CORREÇÃO: Importar db de sorteio.py em vez de criar nova instância
# USAR SHARED DB
...
class ApostaIntuitiva(db.Model):
    ...
    # Campo para registrar COMO chegou nos números
...
class ConferenciaResultado(db.Model):
    ...
    # Campo para análise retrospectiva
