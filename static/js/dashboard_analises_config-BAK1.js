// Configuração FINAL CORRIGIDA de TODAS as Análises do Sistema
// Dashboard de Análises - Dia de Sorte
// Baseado no teste real das APIs
...
const ANALISES_CONFIG = {
    ...
    'atrasados': {
        ...
        rota: '/api/analise/atrasados',  // ✅ CORRIGIDO
        processar: (data) => {
    ...
    'meses': {
        ...
        rota: '/api/analise/meses',  // ✅ CORRIGIDO
        processar: (data) => {
    ...
    'numeros-juntos': {
        ...
        rota: '/api/analise/numeros-juntos',  // ✅ OK
        processar: (data) => {
    ...
    'quentes-frios': {
        ...
        rota: '/api/analise/quentes-frios',  // ✅ OK
        processar: (data) => {
    ...
    'numeros-devidos': {
        ...
        rota: '/api/analise/numeros-devidos',  // ✅ OK
        processar: (data) => {
    ...
    'numeros-repetem': {
        titulo: 'Números que se Repetem',
        icone: 'fa-redo',
        descricao: 'Números repetidos entre sorteios consecutivos',
        rota: '/api/analise/numeros-repetem',  // ✅ OK
        processar: (data) => {
    ...
    'pares-impares': {
        ...
        rota: '/api/analise/pares-impares',  // ✅ OK
        processar: (data) => {
            const padroes = data.padroes || [];
            const top3 = padroes.slice(0, 3).map(p => ({
    ...
    'primos-compostos': {
        ...
        rota: '/api/analise/primos-compostos',  // ✅ OK
        processar: (data) => {
            const padroes = data.padroes || [];
            const top3 = padroes.slice(0, 3).map(p => ({
                descricao: p.descricao,
    ...
    'raiz-digital': {
        ...
        rota: '/api/analise/raiz-digital',  // ✅ OK
        processar: (data) => {
            const padroes = data.padroes || [];
            const top3 = padroes.slice(0, 3).map(p => ({
    ...
    'digitos-unicos': {
        ...
        rota: '/api/analise/digitos-unicos',  // ✅ OK
        processar: (data) => {
            const padroes = data.padroes || [];
            const top3 = padroes.slice(0, 3).map(p => ({
    ...
    'digito-padrao-inicial-final': {
        ...
        rota: '/api/analise/digito-padrao-inicial-final',  // ✅ OK
        processar: (data) => {
    ...
    'quadrantes': {
        ...
        rota: '/api/analise/quadrantes',  // ✅ OK
        processar: (data) => {
            const padroes = data.padroes || [];
            const top3 = padroes.slice(0, 3).map(p => ({
                descricao: p.descricao,
    ...
    'consecutivos': {
        ...
        rota: '/api/analise/consecutivos',  // ✅ OK
        processar: (data) => {
            const padroes = data.padroes || [];
            const top3 = padroes.slice(0, 3).map(p => ({
                descricao: p.descricao || p.padrao,
    ...
    'espelhados': {
        ...
        rota: '/api/analise/espelhados',  // ✅ OK
        processar: (data) => {
            const padroes = data.padroes || [];
            const top3 = padroes.slice(0, 3).map(p => ({
                descricao: p.descricao || p.padrao,
    ...
    'soma-dezenas': {
        ...
        rota: '/api/analise/soma-dezenas',  // ✅ OK
        processar: (data) => {
    ...
    'sequencias': {
        ...
        rota: '/api/analise/sequencias',  // ✅ OK
        processar: (data) => {
            const padroes = data.padroes || [];
            const top3 = padroes.slice(0, 3).map(p => ({
                descricao: p.descricao || p.padrao,
    ...
    'padroes-sequencias': {
        ...
        rota: '/api/analise/padroes-sequencias',  // ✅ OK
        processar: (data) => {
            const padroes = data.padroes || [];
            const top3 = padroes.slice(0, 3).map(p => ({
                descricao: p.descricao || p.padrao,
    ...
    'evolucao-meses': {
        ...
        rota: '/api/analise/evolucao-meses',  // ✅ OK
        processar: (data) => {
            const meses = data.meses || [];
    ...
    'ciclos-meses': {
        ...
        rota: '/api/analise/ciclos-meses',  // ✅ OK
        processar: (data) => {
    ...
    'expectativa-meses': {
        ...
        rota: '/api/analise/expectativa-meses',  // ✅ OK
        processar: (data) => {
    ...
    'transicao-meses': {
        ...
        rota: '/api/analise/transicao-meses',  // ✅ OK
        processar: (data) => {
    ...
    'correlacao-mes-dezenas': {
        ...
        rota: '/api/analise/correlacao-mes-dezenas',  // ✅ OK
        processar: (data) => {
    ...
    'acumulos-mes': {
        ...
        rota: '/api/analise/acumulos-mes',  // ✅ OK
        processar: (data) => {
    ...
    // ========================================================================
    // ANÁLISES PREDITIVAS (3) - Calculadora e Simulador são POST only
    // ========================================================================
    ...
    'previsao-atrasados': {
        ...
        rota: '/api/analise/previsao-atrasados',  // ✅ OK
        processar: (data) => {
    ...
    'matriz-probabilidade': {
        ...
        rota: '/api/analise/matriz-probabilidade',  // ✅ OK
        processar: (data) => {
    ...
    'frequencia-premios': {
        ...
        rota: '/api/analise/frequencia-premios',  // ✅ OK
        processar: (data) => {
    ...
    'ciclos-intervalos': {
        ...
        rota: '/api/analise/ciclos-intervalos',  // ✅ OK
        processar: (data) => {
            const ciclos = data.ciclos || [];
            const top3 = ciclos.slice(0, 3).map(c => ({
    ...
    'repeticao-persistencia': {
        ...
        rota: '/api/analise/repeticao-persistencia',  // ✅ OK
        processar: (data) => {
            const padroes = data.padroes || [];
            const top3 = padroes.slice(0, 3).map(p => ({
                descricao: p.descricao || p.padrao,
    ...
    'distribuicao-numerica': {
        ...
        rota: '/api/analise/distribuicao-numerica',  // ✅ OK
        processar: (data) => {
    ...
    'probabilidade-condicional': {
        ...
        rota: '/api/analise/probabilidade-condicional',  // ✅ OK
        processar: (data) => {
...
// Total: 37 análises funcionando
// Removidas: gaps-completo, gaps-expandido, valores-probabilidades, calculadora-probabilidade, simulador-apostas
