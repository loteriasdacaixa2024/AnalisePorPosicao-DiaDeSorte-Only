...
DB_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'analise_por_posicao.db')
...
def salvar_analise():
    ...
    try:
        ...
        # Conectar ao banco
        db_analises = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'analise_por_posicao.db')
