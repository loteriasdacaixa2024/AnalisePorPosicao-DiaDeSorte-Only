...
@dashboard_analises_bp.route('/dashboard-analises-v2')
def dashboard_analises_v2():
    """Página do dashboard de análises V2 - Com dados reais"""
    return render_template('dashboard_analises_v2.html')
